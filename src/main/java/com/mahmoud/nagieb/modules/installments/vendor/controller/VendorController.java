package com.mahmoud.nagieb.modules.installments.vendor.controller;
...
import com.mahmoud.nagieb.modules.installments.vendor.service.VendorService;
...
public class VendorController {
    ...
    @GetMapping
    public ResponseEntity<Page<VendorSummary>> list(@RequestParam(defaultValue = "0") int page,
                                    @RequestParam(defaultValue = "10") int size,
                                    @RequestParam(required = false) String search) {
        Page<VendorSummary> vendorSummaries = vendorService.list(page, size, search);
