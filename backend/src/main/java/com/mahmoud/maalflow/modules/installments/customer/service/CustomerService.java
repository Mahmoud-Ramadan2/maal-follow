...
//                .collect(Collectors.toList());
    ...
    /**
     * Gets count of active customers with active contracts.
     */
    @Transactional(readOnly = true)
    public long getActiveCustomerCountHasActiveContracts() {
        return customerRepository.countActiveCustomersHasActiveContracts();
    }

    /**
     * Gets count of active customers without active contracts.
     */
    @Transactional(readOnly = true)
    public long getActiveCustomerCountHasNOActiveContracts() {
        return customerRepository.countActiveCustomersHasActiveContracts();
    }
